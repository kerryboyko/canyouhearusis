export default {
  videoPoints: [
    ...
    },
    {
      text: {
        EN: [
          "The new constitution tackles corruption.",
    ...
    },
    {
      text: {
        EN: null,
        IS: [
          "Þórhildur Þorleifsdóttir ræðir hvernig nýja stjórnarskráin færir þjóðinni réttinn að kalla eftir þjóðaratkvæðagreiðslum"
        ]
      },
  ...
  articles: [
    ...
    },
    {
      ...
      authorBios: {
        ...
        IS: [
          "Steven Keeler, heiðursprófessor State University of New York (Cayuga Community College)."
        ]
      },
      text: {
        EN: [
    ...
    },
    {
      ...
      translator: "Ólöf Pétursdóttir",
      authorPics: [
        "/img/authors/carrillo.jpg",
        "/img/authors/duvernay.jpg",
    ...
    },
    {
      ...
      authorBios: {
        ...
        IS: [
          "Delia Popescu, doktor í stjórnmálafræði og deildarstjóri við Lemoyne College í New York fylki."
        ]
      },
      text: {
        EN: [
    ...
    },
    {
      title: {
        EN:
          "For a democratic way forward: The new Icelandic constitution is important for Europe (and the rest of the world)",
        IS:
          "Ný stjórnarskrá Íslands skiptir miklu máli fyrir Evrópu (og heimsbyggð alla)"
      },
      languages: ["EN", "IS"],
      author: "Arne Hintz",
      translator: "Ólöf Pétursdóttir",
    ...
    },
    {
      title: {
        EN:
          "Participate the Icelandic Way: What A Crowdsourced Constitution Can Teach Us About Direct Democracy In a post-Brexit World",
        IS:
          "Þátttaka með íslensku sniði: Hvað getur stjórnarskrá, sem samin er með almennri þátttöku, kennt okkur um beint lýðræði eftir Brexit"
      },
      languages: ["EN", "IS"],
      author: "Lena Ramstetter and Zoe Lefkofridi",
      translator: "Ólöf Pétursdóttir",
      authorPics: [
        "/img/authors/ramstetter.png",
        "/img/authors/lefkofridi.png"
      ],
      authorBios: {
        EN: [
          "Lena Ramstetter, University of Salzburg",
          "Zoe Lefkofridi, University of Salzburg"
        ],
        IS: [
          "Lena Ramstetter, Háskólanum í Salzburg skrifa",
          "Zoe Lefkofridi, Háskólanum í Salzburg skrifa"
        ]
      },
      text: {
        EN: [
...

    {
      ...
      authorBios: {
        EN: [
          "Ragnar Aðalsteinsson, Attorney for the Supreme Court of Iceland."
        ],

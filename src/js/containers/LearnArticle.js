    ...
    return (
      <Card>
        ...
        <CardText expandable={true}>
          ...
          {this.translator ? (
            <div className={css(styles.mainText, styles.translator)}>
              {this.translator + " þýddi"}
            </div>
          ) : null}
          {this.text[this.props.language].map(pgraph => (
            <div className={css(styles.mainText)}>{pgraph}</div>
          ))}
        </CardText>
      </Card>
    );

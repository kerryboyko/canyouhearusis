...
class Party extends Component {
  ...
  render() {
    const yea = (
      <div className={css(styles.goodBackbadge)}>
        <Checkmark className={css(styles.logo)} color={"white"} />
      </div>
    );
    const nay = (
      <div className={css(styles.badBackbadge)}>
        <Cross className={css(styles.logo)} color={"white"} />
      </div>
    );
    const meh = (
      <div className={css(styles.mehBackbadge)}>
        <img src={qMark} className={css(styles.logo)} />
      </div>
    );
    return (

export default {
  EN: {
    part1: [
      ...
      "This Privacy Policy explains how information about you is collected, used and disclosed by this campaign and its affiliated organizations.  This Privacy Policy applies to information we collect when you use the websites, mobile sites, mobile applications and other online services that link to this Privacy Policy (collectively, the \"Sites\").",
    ...
    part3: [
      "This campaign is sponsored by the Icelandic Constitution Society (Stjórnarskrárfélagið), a registered non-profit organisation in Iceland and the information we collect is governed by Icelandic law. By accessing or using the Sites or otherwise providing information to us, you consent to the processing and transfer of information in and to the U.S. and other countries.",
